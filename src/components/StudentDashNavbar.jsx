...
const StudentDashboardNavbar = () => {
    ...
    // You'll want to get this from your auth context or state management
        ...
        <nav className={`${theme === 'dark' ? 'bg-gray-800 shadow-md' : 'bg-white shadow-md'}`}>
            ...
            <div className={`${theme === 'dark' ? 'bg-gray-900' : 'bg-gray-900'} px-6 hidden lg:block`}>
                <div className="max-w-7xl mx-auto flex justify-center items-center space-x-8">
                    <Link to="/student" className="flex items-center py-3 px-1 text-white bg-gray-900 hover:bg-green-600 transition-all duration-300 ease-in-out">
                        <FaHome className="text-xl" />
                        <span className="ml-3">Home</span>
                    </Link>

                    <Link to="/student/library" className="flex items-center py-3 px-1 text-white bg-gray-900 hover:bg-green-600 transition-all duration-300 ease-in-out">
                    ...
                    <Link to="/student/support" className="flex items-center py-3 px-1 text-white bg-gray-900 hover:bg-green-600 transition-all duration-300 ease-in-out">
                        <FaQuestionCircle className="text-xl" />
                        <span className="ml-3">Support</span>
                    </Link>

                    <Link to="/student/announcements" className="flex items-center py-3 px-1 text-white bg-gray-900 hover:bg-green-600 transition-all duration-300 ease-in-out">
                        <FaBell className="text-xl" />
                        <span className="ml-3">Announcements</span>
                    </Link>

                    <Link to="/student/journey" className="flex items-center py-3 px-1 text-white bg-gray-900 hover:bg-green-600 transition-all duration-300 ease-in-out">
                        <FaBell className="text-xl" />
